...
export const getAllAttendanceListRoute ={
    method: 'GET',
    path: '/api/modules/{courseId}/{classDate}/{classStart}/lecturer/{userId}',
    handler:async  (req, h) => {
